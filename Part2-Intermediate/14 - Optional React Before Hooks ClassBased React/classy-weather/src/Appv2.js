    ...
    render() {
        return (
            <div className='app'>
                ...
                <input type='text' placeholder='search for location..' value={this.state.location}
         ...
         return (
             <div>
                 ...
                 <ul className="weather">
                     {dates.map((date, i) => (<Day date={date} max={max.at(i)} min={min.at(i)} key={date} code={codes.at(i)} isToday={i===0}/>))}
                 </ul>
             </div>
         )
     }
